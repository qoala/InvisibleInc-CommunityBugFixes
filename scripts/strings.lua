...
local MOD_STRINGS =
{
	OPTIONS =
	{
		...
		LASERDRAGSYMMETRY = "FIX LASER BEAM ALLY CHECKS",
		LASERDRAGSYMMETRY_TIP = "<c:FF8411>FIX LASER BEAM ALLY CHECKS</c>\nCorp-controlled lasers turn off when guards walk through, and likewise for agency-controlled lasers and agents. Corp-controlled lasers also turn off when an agent drags a guard through.\nHowever agency-controlled trip against a guard being dragged by an agent.\nThis fix makes lasers self-disable if either the dragging unit or the dragged unit is an ally.",
